...
const char *WINDOWTITLE = { "Voxel Coloring" };
...
//
// Usar para escribir en la ventana:
//
...
void InitGlui( void )
{
    ...
    Glui->add_radiobutton_to_group( group, "Voxel Coloring" );
...
{
    return floorf(x * 10) / 10;
}

void Cubo(float x , float y , float z , float tam, cv::Scalar color, int opaco)
{
    float r = tam/2;
    if (opaco == 0){
    ...
    float red = pround(color[2]/255);
    float green = pround(color[1]/255);
    float blue = pround(color[0]/255);
   // if(red != 0 and green != 0 and blue != 0)
    glColor3f(red, green, blue);
    
    //glColor3f(0.2, 0.4, 0.5);
    //std::cout << color[0]/255 << " "<< color[1]/255 << " "<< color[2]/255<< std::endl;
    //std::cout << pround(color[0]/255)<< " "<< pround(color[1]/255) << " "<< pround(color[2]/255)<< std::endl;
    //front
...
//Leeremos el objeto creado por opencv para su reconstruccion+
void DibujarObjeto(int tamanio){
    std::vector<cv::Mat> vecim;
    vecim.push_back(leeimagen((char*)"/Users/Carlos/Documents/Programas/ProyectoVC/ProyectoVC/Craneo/visualize/00.jpg", 1));
    vecim.push_back(leeimagen((char*)"/Users/Carlos/Documents/Programas/ProyectoVC/ProyectoVC/Craneo/visualize/01.jpg", 1));
    //vecim.push_back(leeimagen((char*)"/Users/Carlos/Documents/Programas/ProyectoVC/ProyectoVC/Craneo/visualize/02.jpg", 1));
    //vecim.push_back(leeimagen((char*)"/Users/Carlos/Documents/Programas/ProyectoVC/ProyectoVC/Craneo/visualize/03.jpg", 1));
    //vecim.push_back(leeimagen((char*)"/Users/Carlos/Documents/Programas/ProyectoVC/ProyectoVC/Craneo/visualize/04.jpg", 1));
    //vecim.push_back(leeimagen((char*)"/Users/Carlos/Documents/Programas/ProyectoVC/ProyectoVC/Craneo/visualize/05.jpg", 1));
    //vecim.push_back(leeimagen((char*)"/Users/Carlos/Documents/Programas/ProyectoVC/ProyectoVC/Craneo/visualize/06.jpg", 1));
    //vecim.push_back(leeimagen((char*)"/Users/Carlos/Documents/Programas/ProyectoVC/ProyectoVC/Craneo/visualize/07.jpg", 1));
    
    std::vector<cv::Mat> siluetas = CrearSilhouttes(vecim);
    //cv::imwrite("/Users/Carlos/Desktop/silueta.jpg", siluetas[0]);
    //pintaI(siluetas[1]);
    Voxel v(120);
    float tam = v.Inicializar(750);
    StructVoxel p;
    
    for(int i = 1; i < vecim.size();i++){
        VoxelColoring2(vecim[i-1],i-1, vecim[i],i, v, siluetas[i-1],siluetas[i]);
